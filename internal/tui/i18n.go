...
var zhStrings = map[string]string{
	...
	// ── Auth Files ──
	"auth_title":               "🔑 认证文件",
	"auth_help1":               " [↑↓/jk] 导航 • [Enter] 展开 • [e] 启用/停用 • [d] 单删 • [D] 批删 • [r] 刷新",
	"auth_help2":               " [1] 编辑 prefix • [2] 编辑 proxy_url • [3] 编辑 priority • [x/X] 多选 • [u] 仅看 401",
	"auth_state":               "  过滤: %s • 已选: %d",
	"auth_filter_all":          "全部",
	"auth_filter_unauthorized": "unauthorized",
	"selected_auth_files":      "%d 个认证文件",
	"no_auth_files":            "  无认证文件",
	"no_auth_matches":          "  当前筛选下无 unauthorized 账号",
	"confirm_delete":           "⚠ 删除 %s? [y/n]",
	"deleted":                  "已删除 %s",
	"deleted_selected":         "已批量删除 %d 个认证文件",
	"enabled":                  "已启用",
	"disabled":                 "已停用",
...
var enStrings = map[string]string{
	...
	"auth_help1":               " [↑↓/jk] Navigate • [Enter] Expand • [e] Enable/Disable • [d] Delete one • [D] Delete selected • [r] Refresh",
	"auth_help2":               " [1] Edit prefix • [2] Edit proxy_url • [3] Edit priority • [x/X] Select • [u] Unauthorized only",
	"auth_state":               "  Filter: %s • Selected: %d",
	"auth_filter_all":          "all",
	"auth_filter_unauthorized": "unauthorized",
	"selected_auth_files":      "%d auth files",
	"no_auth_files":            "  No auth files found",
	"no_auth_matches":          "  No unauthorized auth files match the current filter",
	"confirm_delete":           "⚠ Delete %s? [y/n]",
	"deleted":                  "Deleted %s",
	"deleted_selected":         "Deleted %d auth files",
	"enabled":                  "Enabled",
	"disabled":                 "Disabled",
